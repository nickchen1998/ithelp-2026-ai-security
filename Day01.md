...
2. **先看懂骨架的人，享有先行者優勢。** 作用法不會憑空長出來，它一定會沿著三樣東西生長：基本法的原則、國際上already成熟的標準、以及台灣既有的評測驗證制度。現在先把這個骨架讀懂，等細則落地時，你只是在「填空」，而不是從頭「重學」。
