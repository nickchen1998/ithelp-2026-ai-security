...
1. 「AIEC：台灣 AI 可信任度的官方基礎設施」列出十大評測項目處：「當責性」與前文（Day 8 的「問責」、Day 11 的「可歸責性」）是同一概念（accountability），但此處未做任何銜接，跨篇讀者可能以為是新概念。建議在「當責性」後加短註，如「（即前文所稱『問責』，此處採 AIEC 官方用語）」。
2. 開頭第三問問的是「測完之後的『證書』是誰發的」，但後文（含「三個問題有了答案」第 3 點）答的是「評價報告／評價結果」，一問一答用詞未對齊。建議在第三層或作答處補一句，說明評測制度的正式產出名稱（評價報告，或如有證書／標章則明確指出），讓「證書」與「評價報告」不致被讀成兩件事。
═══════════════════════════════════════════════════════════ -->
