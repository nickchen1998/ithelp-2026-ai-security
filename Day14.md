...
1. 「高風險應用要負哪些義務」清單末項「符合性評鑑（上市前要通過的官方合格查驗）與（部分）CE 標誌」有兩處失準：其一，多數高風險 AI（附件 III 類，生物特徵相關除外）的符合性評鑑可由提供者依「內部控制」程序自行完成，僅特定類別須經第三方指定機構查驗，「官方合格查驗」易被誤讀為一律送官方檢查；其二，CE 標誌是「所有」高風險 AI 上市前的必要標記，「（部分）」限定詞放錯位置——真正「部分適用」的是第三方查驗，不是 CE 標誌。建議整行改寫，例如「上市前的符合性評鑑（多數情形由提供者依內部控制程序完成，特定類別須經第三方查驗）與 CE 標誌」。
2. 「仔細看這份清單…」段末「等一下講 42001 當共通語言時就會用到」屬口語部落格腔，建議改為「後文討論 42001 作為共通語言時，將再回到這個重疊」。
═══════════════════════════════════════════════════════════ -->
